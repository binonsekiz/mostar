...
public class ColorGrid extends VBox {
  ...
  public final static double MIN_TILE_SIZE = 14;
  ...
  private static String[][] webPalette = {
  ...
  public ColorGrid(String[][] colors) {
    ...
    for (String[] namedColor : colors) {
      ...
      colorChoice.setMaxSize(MIN_TILE_SIZE, MIN_TILE_SIZE);
